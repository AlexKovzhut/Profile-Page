...
class AlbumsTableViewCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        stackView = UIStackView(arrangedSubviews: [artistNameLabel, trackCountLabel], axis: .horizontal, spacing: 10, distibution: .equalCentering)
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.leadingAnchor.constraint(equalTo: albumLogo.leadingAnchor, constant: 10),
